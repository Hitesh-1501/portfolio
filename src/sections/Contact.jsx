  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute top-1/3 right-[-10%] w-[600px] h-[600px] bg-[#3DDC84]/[0.012] blur-[160px] rounded-full pointer-events-none -z-10" />
        <div className="absolute bottom-1/4 left-[-10%] w-[600px] h-[600px] bg-cyan-500/[0.012] blur-[160px] rounded-full pointer-events-none -z-10" />
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-slate-400 mt-5 text-base md:text-lg leading-relaxed font-semibold max-w-2xl">
        ...
        {/* --- QUICK ACTION BUTTONS BAR (Optimized Hover Scaling & Glows) --- */}
        <motion.div 
          variants={containerVariants}
          initial="hidden"
          whileInView="visible"
        ...
        >
          <motion.a 
            ...
            whileHover={{ y: -3, scale: 1.02, boxShadow: "0 10px 25px rgba(61,220,132,0.3)" }}
            whileTap={{ scale: 0.98 }}
          ...
          <motion.a 
            ...
            target="_blank"
            rel="noreferrer"
            whileHover={{ y: -3, scale: 1.02, bg: "rgba(255,255,255,0.05)", borderColor: "rgba(255,255,255,0.25)" }}
            whileTap={{ scale: 0.98 }}
          ...
          {/* FIXED: Self-contained GitHub button alignment & scale */}
          <motion.a 
            variants={itemVariants}
            href="https://github.com/Hitesh-1501" 
            target="_blank" 
            rel="noreferrer"
            whileHover={{ y: -3, scale: 1.1, text: "white" }}
            className="p-2.5 bg-white/[0.01] border border-white/[0.04] text-slate-400 hover:text-white rounded-xl hover:bg-white/[0.03] transition-all flex items-center justify-center h-9 w-9"
          >
        ...
        {/* --- MAIN RECRUITER INFO GRID (With Deepened Hover Glow Matrixes) --- */}
        <motion.div 
          variants={containerVariants}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, margin: "-40px" }}
          className="grid md:grid-cols-3 gap-6 items-start w-full"
        >
          {/* Email Tile */}
          <motion.div 
            variants={itemVariants}
            ...
            whileHover={{ 
              ...
              boxShadow: "0 25px 50px -12px rgba(0,0,0,0.7), 0 0 30px rgba(61,220,132,0.04)"
            }}
          ...
          {/* Location Tile (Fixed Live India Time Integration) */}
          <motion.div 
            variants={itemVariants}
            whileHover={{ 
              y: -6, 
              ...
              backgroundColor: "rgba(15,23,42,0.6)",
              boxShadow: "0 25px 50px -12px rgba(0,0,0,0.7), 0 0 30px rgba(34,211,238,0.04)"
            }}
          ...
          >
            ...
            {/* FIXED: Swapped raw text with dynamic India Standard Time string */}
          ...
          <motion.div 
            ...
            whileHover={{ 
              ...
              backgroundColor: "rgba(15,23,42,0.6)",
              boxShadow: "0 25px 50px -12px rgba(0,0,0,0.7), 0 0 30px rgba(168,85,247,0.04)"
            }}
            className="backdrop-blur-xl bg-slate-900/40 border border-white/[0.06] rounded-3xl p-6 shadow-2xl transition-all duration-300 min-h-[165px] flex flex-col justify-between"
          >
            <div>
        ...
        {/* --- CV RESUME DIRECT FILE DOWNLOAD RECTANGLE --- */}
        <motion.div 
          ...
          className="mt-6 w-full backdrop-blur-xl bg-white/[0.01] border border-white/[0.04] rounded-3xl p-6 md:p-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 transition-all duration-300"
        >
          <div>
          ...
          <a 
            ...
            className="px-6 py-3 bg-white/[0.02] hover:bg-white/[0.05] border border-white/10 hover:border-white/20 text-white text-xs font-black uppercase tracking-wider rounded-xl transition-all duration-200 flex items-center justify-center gap-2 shrink-0 group/dl shadow-inner"
          >
        ...
        <div className="mt-16 w-full">
          ...
          >
            {[
              ...
              { name: "GitHub", desc: "Explore my Android projects and repositories.", path: "https://github.com/Hitesh-1501", icon: <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12c0 4.42 2.865 8.166 6.839 9.489.5.092.682-.217.682-.483 0-.237-.008-.866-.013-1.7-2.782.603-3.369-1.34-3.369-1.34-.454-1.156-1.11-1.464-1.11-1.464-.908-.62.069-.061.069-.061 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.831.092-.646.35-1.086.636-1.336-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.579.688.481C19.138 20.161 22 16.416 22 12c0-5.523-4.477-10-10-10z"/></svg> },
              ...
              <motion.a 
                ...
                className="backdrop-blur-md bg-white/[0.01] border border-white/[0.03] rounded-2xl p-5 transition-all duration-300 flex flex-col justify-between min-h-[135px] group/s"
              >
